(() => {
  ...
  const translations = {
    es: {
      ...
      "contact.eyebrow": "Comience su plan de abastecimiento", "contact.title": "Cuéntenos qué<br /><em>quiere crear.</em>", "contact.copy": "Comparta lo esencial. Nuestro equipo revisará su solicitud y responderá con un siguiente paso práctico.", "contact.gallery.client": "Trabajando junto a nuestros clientes", "contact.gallery.team": "Equipo ROYAL UNION · MU Group", "form.name": "Nombre completo", "form.email": "Correo electrónico empresarial", "form.whatsapp": "Número de WhatsApp (opcional)", "form.company": "Empresa", "form.market": "Mercado principal", "form.source": "¿Qué desea abastecer?", "form.submit": "Solicitar un plan de abastecimiento", "form.note": "Al enviar, acepta que nos pongamos en contacto sobre su solicitud de abastecimiento.",
    ...
    "pt-BR": {
      ...
      "contact.eyebrow": "Comece seu plano de sourcing", "contact.title": "Conte-nos o que<br /><em>você quer criar.</em>", "contact.copy": "Compartilhe o essencial. Nossa equipe analisará sua solicitação e retornará com um próximo passo prático.", "contact.gallery.client": "Trabalhando lado a lado com nossos clientes", "contact.gallery.team": "Equipe ROYAL UNION · MU Group", "form.name": "Nome completo", "form.email": "E-mail corporativo", "form.whatsapp": "Número do WhatsApp (opcional)", "form.company": "Empresa", "form.market": "Mercado principal", "form.source": "O que você deseja comprar?", "form.submit": "Solicitar um plano de sourcing", "form.note": "Ao enviar, você concorda em ser contatado sobre sua solicitação de sourcing.",
    ...
    "zh-CN": {
      ...
      "contact.eyebrow": "启动您的采购方案", "contact.title": "告诉我们您<br /><em>想要打造什么。</em>", "contact.copy": "请分享核心需求。我们的团队将审核您的请求，并提供可执行的下一步建议。", "contact.gallery.client": "与客户并肩协作", "contact.gallery.team": "ROYAL UNION 团队 · MU集团", "form.name": "姓名", "form.email": "企业邮箱", "form.whatsapp": "WhatsApp 号码（选填）", "form.company": "公司名称", "form.market": "主要市场", "form.source": "您希望采购什么？", "form.submit": "申请采购方案", "form.note": "提交后，您同意我们就采购需求与您联系。",
  ...
  setContent("#contact .contact-gallery figure:nth-child(1) figcaption", "contact.gallery.client");
  setContent("#contact .contact-gallery figure:nth-child(2) figcaption", "contact.gallery.team");
  setLeadingText(".inquiry-form > label:nth-of-type(1)", "form.name");
  setLeadingText(".inquiry-form > label:nth-of-type(2)", "form.email");
  setLeadingText('[data-form-label="whatsapp"]', "form.whatsapp");
