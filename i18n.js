(() => {
  ...
  const translations = {
    ...
    "zh-CN": {
      ...
      "contact.eyebrow": "启动您的采购方案", "contact.title": "告诉我们您<br /><em>想要打造什么。</em>", "contact.copy": "请分享核心需求。我们的团队将审核您的请求，并提供可执行的下一步建议。", "contact.gallery.client": "与客户并肩协作", "contact.gallery.team": "ROYAL UNION 团队 · MU集团", "form.name": "姓名", "form.email": "企业邮箱", "form.company": "公司名称", "form.market": "主要市场", "form.source": "您希望采购什么？", "form.submit": "申请采购方案", "form.note": "提交后，您同意我们就采购需求与您联系。",
